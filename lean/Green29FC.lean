...
/-!
# Green's Open Problem 29: exact Formal Conjectures target

This file imports the validator-pinned Formal Conjectures statement and proves that its
right-hand proposition is false.  The final theorem has the proposed solved form
`answer(False) ↔ ...`.
...
/-- The proposition on the right-hand side of `Green29.green_29` is false. -/
...
/-- Proposed solved form of the exact Formal Conjectures declaration. -/
